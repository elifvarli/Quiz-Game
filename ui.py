...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.canvas = Canvas(bg="white", height=250, width=300, highlightthickness=0, highlightbackground=THEME_COLOR,)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            messagebox.showinfo(message=f"Your final score is: {self.quiz.score}/10")
